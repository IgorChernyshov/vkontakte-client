//
//  SetNewsFeedTextAndPhotoCellImagesToRow.swift
//  igor-chernyshov
//
...
class SetNewsFeedTextAndPhotoCellOwnerProfileImageToRow: Operation {
  
  private let indexPath: IndexPath
  private weak var tableView: UITableView?
  private var cell: NewsFeedTextAndPhotoCell?
  
  init(cell: NewsFeedTextAndPhotoCell, indexPath: IndexPath, tableView: UITableView) {
...
class SetNewsFeedTextAndPhotoCellAttachedPhotoToRow: Operation {
