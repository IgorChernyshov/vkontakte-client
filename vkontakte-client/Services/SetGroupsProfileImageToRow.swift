//
//  SetGroupsProfileImageToRow.swift
//  igor-chernyshov
//
...
class SetGroupsProfileImageToRow: Operation {
  
  private let indexPath: IndexPath
  private weak var tableView: UITableView?
  private var cell: MyGroupsCell?
  
  init(cell: MyGroupsCell, indexPath: IndexPath, tableView: UITableView) {
