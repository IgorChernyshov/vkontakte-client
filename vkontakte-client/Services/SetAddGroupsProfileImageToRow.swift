//
//  SetAddGroupsProfileImageToRow.swift
//  igor-chernyshov
//
...
class SetAddGroupsProfileImageToRow: Operation {
  
  private let indexPath: IndexPath
  private weak var tableView: UITableView?
  private var cell: AddGroupCell?
  
  init(cell: AddGroupCell, indexPath: IndexPath, tableView: UITableView) {
